...
describe('Triangle', () => {
  ...
  test('should correctly determine whether three lengths make a scalene tiangle', () => {
    const scalTriangle = new Triangle(4, 5, 7);
    expect(scalTriangle.checkType()).toEqual("scalene triangle");
  });
  test('should correctly determine whether three lengths make an isocelese tringle', () => {
...
//   });
//   test('value of num is a multiple of 3 or 5',  () => {
//     const num = new NaturalNumber();
//     expect (num.notMultipleOf3Or5(3)).toEqual(true);
//   });
// });
